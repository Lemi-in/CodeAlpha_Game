...
socket.on("find", (e) => {
    ...
    if (name != '') {
        ...
        document.getElementById("whosTurn").innerText = `${name}'s Turn`;
    }
...
socket.on("playing", (e) => {
    ...
    if ((foundObject.sum) % 2 === 0) {
        currentPlayerName = foundObject.p1.p1name;
    } else {
        currentPlayerName = foundObject.p2.p2name;
    }

    document.getElementById("whosTurn").innerText = `${currentPlayerName}'s Turn`;
    document.getElementById("oppName").innerText = `Opponent: ${foundObject.p1.p1name === currentPlayerName ? foundObject.p2.p2name : foundObject.p1.p1name}`;
